...
images_directory: str = "D:\\Studium\\Informatik\\9. Semester (Master)\\Masterarbeit\\Weitere Muenzsets\\GL_Bilder\\reverse\\"  # Example string for windows

# Path were the preprocessed images and the results will be stored.
# Same rules for the path as for "images_path"
results_directory: str = "D:\\Studium\\Informatik\\9. Semester (Master)\\Masterarbeit\\Weitere Muenzsets\\GL_Bilder\\reverse_results\\" # Example string for windows
